            ...
            <div class="card">
                <div class="card-header">
                    <div class="dropdown">
                        ...
                        <!-- Liste qui affiche la forme d'ajout d'une platforme -->
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered ">
                        <thead class="table-secondary ">
                            <th>
                                ...
                                <!-- Liste pour ajouter serveur a la platforme-->
                                <div class="dropdown">
                                    <!-- Recuperation platforme ID-->
                                    Plateforme N°{{$Platforme->id}}: {{$Platforme->NomPlatforme}}
                    ...
                    <!-- Tableau affichant la liste des serveurs de la platforme-->
                    <table class="table table-bordered ">
                        <!-- Entete -->
                    ...
                    <!-- Tableau des serveurs qui ont perdu leurs platforme-->
                    <table class="table table-bordered ">
                        <thead class="thead-dark">
                            <th>ID</th>
                            <th>Designation</th>
