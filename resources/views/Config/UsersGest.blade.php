                        ...
                        <table class="table table-bordered ">
                            ...
                            @foreach($users as $user)
                                    ...
                                    <tr>
                                        ...
                                        <button class="dropdown-item" style="border: solid;  border-width: 1px; border-color: #d8d8d8" type="submit" form="form1_{{$user->id}}" value="Submit">Modifier role</button>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            @if( ! empty($user['id']))
                                                <button type="button" class="btn btn-primary" ><a href="{{url('admin/users/delete/'.$user->id)}} " style="color:white" >Confirmer </a></button>
                                            @endif
                                        </div>
                                    </div>
                                </div>
